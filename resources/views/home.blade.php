        ...
        <div class="slide-item">
            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <div class="btn-box">
                        <a href="{{ url('contact') }}" class="user-btn"><i class="far fa-user"></i><span>Make Contact
                                With an
                                Expert</span></a>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                    ...
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('images/resource/feature-1.jpg') }}" alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                                <h3>Wealth Management</h3>
                                <a href="{{ url('wealth_management') }}"><span>Learn more</span><i
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="300ms"
                    data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('images/resource/feature-2.jpg') }}" alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                                <h3>Real Estate</h3>
                                <a href="{{ url('real_estate') }}"><span>Learn more</span><i
                                        class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                <div class="feature-block-one wow fadeInUp animated animated" data-wow-delay="600ms"
                    data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><img src="{{ asset('images/resource/feature-3.jpg') }}" alt="">
                        </figure>
                        <div class="lower-content">
                            <div class="inner">
                                <h3>Hedge Funds</h3>
                                <a href="{{ url('hedge_funds') }}"><span>Learn more</span><i
                                        class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="image_block_four">
                    <div class="image-box">
                        ...
                        <figure class="image wow slideInRight animated animated" data-wow-delay="00ms"
                            data-wow-duration="1500ms"><img src="{{ asset('images/resource/about-3.jpg') }}" alt="">
                        </figure>
                    </div>
                </div>
            </div>
        ...
        <div class="tabs-box">
            ...
            <div class="tabs-content">
                <div class="tab active-tab" id="tab-1">
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{ asset('images/service/service-1.jpg') }}" alt="">
                            </figure>
                        </div>
                ...
                <div class="tab" id="tab-2">
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{ asset('images/service/service-2.jpg') }}" alt="">
                            </figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                            <div class="content-box">
                ...
                <div class="tab" id="tab-3">
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{ asset('images/service/service-3.jpg') }}" alt="">
                            </figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                            <div class="content-box">
                ...
                <div class="tab" id="tab-4">
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{ asset('images/service/service-4.jpg') }}" alt="">
                            </figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                            <div class="content-box">
                ...
                <div class="tab" id="tab-5">
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="{{ asset('images/service/service-5.jpg') }}" alt="">
                            </figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                            <div class="content-box">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                <div id="image_block_one">
                    <div class="image-box">
                        ...
                        <div class="award-box">
                            <div class="box">
                                <figure class="icon-box"><img src="{{ asset('images/icons/icon-1.png') }}" alt="">
                                </figure>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 info-column">
                    <div class="info-inner">
                        ...
                        <div class="info-box">
                            <figure class="info-logo"><img src="{{ asset('images/icons/info-logo.png') }}" alt="">
                            </figure>
            ...
            <div class="client-thumb-outer">
                <div class="client-thumbs-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{ asset('images/resource/testimonial-1.jpg') }}" alt="">
                        </figure>
                        <div class="info-box">
                            <h5>Robert Smith</h5>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{ asset('images/resource/testimonial-2.jpg') }}" alt="">
                        </figure>
                        <div class="info-box">
                            <h5>Christine Eva</h5>
                            <span class="designation">Senior Manager</span>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{ asset('images/resource/testimonial-3.jpg') }}" alt="">
                        </figure>
                        <div class="info-box">
                            <h5>Jhon Doe</h5>
                            <span class="designation">Senior Manager</span>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{ asset('images/resource/testimonial-4.jpg') }}" alt="">
                        </figure>
                        <div class="info-box">
                            <h5>Robert</h5>
                            <span class="designation">Senior Manager</span>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{ asset('images/resource/testimonial-5.jpg') }}" alt="">
                        </figure>
                        <div class="info-box">
                            <h5>Tomas Tom</h5>
                            <span class="designation">Senior Manager</span>
