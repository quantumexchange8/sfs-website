                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                        <div class="footer-widget logo-widget">
                            <figure class="footer-logo"><a href="index.html"><img src="/images/footer-logo-white.png"
                                        alt=""></a></figure>
                            <div class="text">
                                <p>Excepteur tempor incididunt ut labore et dolore magna aliqua. Aute irure.</p>
                            </div>
