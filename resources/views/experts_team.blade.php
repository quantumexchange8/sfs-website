                ...
                <div class="team-block-three">
                    <div class="inner-box">
                        <figure class="image-box">
                            ...
                            <img src="{{ asset('images/team/team-8.jpg') }}" alt="">
                            <ul class="social-links clearfix">
                        ...
                        <div class="lower-content">
                            ...
                            <span class="designation">Founder CEO</span>
                            <p>An adept programmer and seasoned financial planning advisor with a wealth of experience.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-block-three">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            ...
                            <p>Proficient in marketing strategies and skilled in cultivating a prominent reputation for
                                her professional endeavors.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="team-block-three">
                    <div class="inner-box">
                        <figure class="image-box">
                            <div class="bg-box-1"></div>
                            <div class="bg-box-2"></div>
                            <img src="{{ asset('images/team/team-10.jpg') }}" alt="">
                            <ul class="social-links clearfix">
                                <li><a href="team.html"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="team.html"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="team.html"><i class="fab fa-instagram"></i></a></li>
                        ...
                        <div class="lower-content">
                            ...
                            <p>Abundantly experienced in the business realm, boasting an extensive network poised to
                                catalyze success and growth.</p>
                        </div>
                    </div>
                </div>
            </div>
